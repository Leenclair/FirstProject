...
public class PosGUI extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        btAme.setFont(new java.awt.Font("맑은 고딕", 0, 11)); // NOI18N
        btAme.setText("아메리카노");

        btEs.setFont(new java.awt.Font("맑은 고딕", 0, 11)); // NOI18N
        btEs.setText("에스프레소");

        btLatte.setText("카페라떼");

        btVanila.setFont(new java.awt.Font("맑은 고딕", 0, 11)); // NOI18N
        btVanila.setText("바닐라라떼");

        btHazel.setFont(new java.awt.Font("맑은 고딕", 0, 11)); // NOI18N
        ...
        btMilktea.setFont(new java.awt.Font("맑은 고딕", 0, 11)); // NOI18N
...
//                     table.getValueAt(i,2).toString();
                    ...
                    if(result>0) {
                        JOptionPane.showMessageDialog(this, "결제 되었습니다");
                    }else if(result<=0){
                        JOptionPane.showMessageDialog(this, "결제 실패, 화면을 확인하세요");
                    }
                } catch (SQLException ex) {
                    Logger.getLogger(PosGUI.class.getName()).log(Level.SEVERE, null, ex);
                }
